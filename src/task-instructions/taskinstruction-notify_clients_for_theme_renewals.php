...
function nxs_get_remindergroups_for_themes()
{
...
function nxs_task_instance_do_notify_clients_for_theme_renewals($then_that_item, $taskid, $taskinstanceid)
{
	...
	$remindergroups = nxs_get_remindergroups_for_themes();
	...
	foreach ($remindergroups as $remindergroup)
	{
		...
		$listlicenses_url = nxs_addqueryparametertourl_v2($listlicenses_url, "requirement_license_type", "theme", true, true);
