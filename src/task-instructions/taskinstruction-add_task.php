...
function nxs_task_instance_do_add_task($then_that_item, $taskid, $taskinstanceid)
{
  ...
  $fetch_url = nxs_addqueryparametertourl_v2($fetch_url, "title", $task_title, true, true);
